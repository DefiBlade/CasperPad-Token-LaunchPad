...
const projects = [
    {
        ...
        cap: '$190,000',
        access: 'Private',
        message: 'SkyBridger is a Bridge between Casper Network and other chains, starting with Binance Smart Chain. SkyBridger is made for the community to earn fees by holding its token, $SKBR. The Decentralized nature of SkyBridger makes it so that the project is owned by the community.'
    },
    {
